...
public class Adkar_Bad_Salat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adkar_bad_salat);
    ...
    public void storeDataInArrays(){
        Cursor cursor =MainActivity.getMyDB().readAdkarBadSalat();
